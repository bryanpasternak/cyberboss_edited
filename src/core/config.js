...
function readConfig() {
  ...
  return {
    ...
    qqWsUrl: readTextEnv("CYBERBOSS_QQ_WS_URL") || "ws://127.0.0.1:3001",
    qqAccessToken: readTextEnv("CYBERBOSS_QQ_ACCESS_TOKEN"),
    qqSelfId: readTextEnv("CYBERBOSS_QQ_SELF_ID"),
    qqAllowedUserIds: readListEnv("CYBERBOSS_QQ_ALLOWED_USER_IDS"),
    qqMediaHostDir: readTextEnv("CYBERBOSS_QQ_MEDIA_HOST_DIR"),
    qqMediaContainerDir: readTextEnv("CYBERBOSS_QQ_MEDIA_CONTAINER_DIR") || "/app/napcat/plugins",
    qqMediaBase64MaxBytes: readIntEnv("CYBERBOSS_QQ_MEDIA_BASE64_MAX_BYTES") || 2 * 1024 * 1024,
